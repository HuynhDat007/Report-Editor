...
- **Tính Năng Xem Trước PDF Trực Tiếp Cạnh Bên (Live PDF Preview side-by-side)**:
  ...
  - Tách vùng hiển thị trung tâm thành hai pane: **Canvas Pane** (để chỉnh sửa phần tử) và **Preview Pane** (chứa iframe hiển thị PDF) ngăn cách bởi một thanh kéo giãn **Pane Resizer** nằm dọc.
